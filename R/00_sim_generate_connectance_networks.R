...
# script to generate simulated networks with increasing connectance
...
save(sim.matrices,file = "results/sim_connectance_network_matrices.RData")
write.csv2(sim.networks,"results/sim_connectance_networks.csv",row.names = FALSE)
