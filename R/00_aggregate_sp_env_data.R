...
# keep only frugivores. Acanthis flammea is a special case, a species that appears in tier1
# and in the species list (by the name of carduelis flammea), 
# but has no GBIF observations posterior to 2010
# so it does not appear in the "obs.df" dataset.
birds.tier1.2 <- subset(birds.tier1, species %in% sp.list | species == "Acanthis flammea")
