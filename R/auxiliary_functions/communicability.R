...
#' weighted communicability. The latter is calculated in the same way as the binary 
...
communicability <- function(A, binary = TRUE, 
  ...
  if(sum(A<0)>1){
    message("Communicability function: input matrix contains negative numbers. These will be converted
