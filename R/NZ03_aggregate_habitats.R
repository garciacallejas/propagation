...
# this data is too big to add to github - it can be downloaded from https://zenodo.org/record/4058819
...
habitat.long$habitat_type <- recode(habitat.long$habitat_type,
                                    ...
                                    "8. Desert" = "alpine_areas", # looking at the map, this is permanent snow/high mountains
